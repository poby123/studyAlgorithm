...
/*
접근: 
	처음에는 직접적으로 연결된 것만 가능한 건줄 알아서 인접행렬로 나타내고, bfs로 풀려고 했는데 아니었다.
	간접적으로 연결되서, 어떻게든 갈 수만 있으면 되므로, 그리고 무향그래프이므로, 
	서로소 집합 Union-Find를 이용해서 푼다.
*/
